...
import {editTemplateOperations, editTemplateSelectors} from '../../../modules/templates/routes/EditTemplate/ducks';
...
export default connect(mapStateToProps, mapDispatchToState)(UndoRedoButton);