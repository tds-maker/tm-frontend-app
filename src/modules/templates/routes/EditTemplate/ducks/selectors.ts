...
const infoLanguagesAsText = (state: IStore) => (state.template.editTemplate.info.languages.map(language => config.languages[language])).join(', ');
...
const activePage = (state: IStore) => state.template.editTemplate.design.pages[state.template.editTemplate.options.activePage]
const activePageMargin = (state: IStore) => activePage(state)._meta.margin;
const activePageBody = (state: IStore) => state.template.editTemplate.design.bodies[state.template.editTemplate.options.activePage];
...
const selectedElement = (state: IStore) => state.template.editTemplate.design.elements.selectedElement;
