...
export interface IPagesStore { [key:number] : IPage }

export interface IBody { style: object }
export interface IBodyStore { [key: number] : IBody}
...
export interface IHeaderStore { [key: number] : IHeader}
...
export interface IFooterStore { [key: number] : IFooter}
