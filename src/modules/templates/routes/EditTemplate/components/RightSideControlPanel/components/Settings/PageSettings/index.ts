...
const mapDispatchToProps = (dispatch:any) => ({
    ...
    changeHeaderState : (isEnabled:boolean) => dispatch(editTemplateOperations.changeHeaderStatus(isEnabled)),
    changeFooterState : (isEnabled:boolean) => dispatch(editTemplateOperations.changeFooterStatus(isEnabled))
})
