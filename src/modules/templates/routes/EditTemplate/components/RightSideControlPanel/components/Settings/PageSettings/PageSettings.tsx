    ...
    public render(){
        ...
        return (
            <React.Fragment>
                ...
                <h5>Page Settings</h5>
                    <BodySpacing bottom={bottom} right={right} left={left} top={top} handleChange={changePadding} />
                </div>
                <div className="body-padding-box" style={{marginTop: "30px"}}>
                    <h5>Header</h5>
                    <SwitchButton checked={hasHeader} id="enable-disable-header" onChange={this.onHeaderStatusChange}/>
                    <span>Enabled - Disabled</span>
                </div>
                <div className="body-padding-box" style={{marginTop: "30px"}}>
                    <h5>Footer</h5>
                    <SwitchButton checked={hasFooter} id="enable-disable-footer" onChange={this.onFooterStatusChange}/>
                    <span>Enabled - Disabled</span>
                </div>
            </React.Fragment>
        )
