...
class PageHeader extends React.Component<IProps> {
    ...
    public render(){
        ...
        if(header){
            ...
            return (<Resizer directions={['s']} size={{ height }} onResized={this.onHeaderHeightChange}>
                <div id="page-header" style={header.style} onClick={this.props.selectHeader.bind(this, header, {
                    type: 'header'
