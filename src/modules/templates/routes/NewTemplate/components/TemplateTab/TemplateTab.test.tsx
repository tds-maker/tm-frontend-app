...
describe("NewTemplate First Tab Component", () => {
  ...
  describe("First column", () => {
    ...
    it("should have correct children", () => {
      ...
      expect(firstColumn.childAt(1).props().placeholder).toEqual(
        "Please write template name"
      );
      ...
      expect(firstColumn.childAt(3).props().placeholder).toEqual(
        "Select an item"
      );
  ...
  describe("Second column", () => {
    ...
    it("should have correct children", () => {
      ...
      expect(secondColumn.childAt(7).props().placeholder).toEqual(
        "Select an item"
      );
    });
  });
