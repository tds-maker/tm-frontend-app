...
export default class TemplatesTable extends React.PureComponent<IProps> {
	...
	public render() {
		...
		const templates = this.props.templates
			? this.props.templates.filter(x => x.folderId === folderId)
			: ([] as Template[])
		return (
			<div style={{ flex: '1' }}>
				...
				{templates.length <= 0 && (
					<div className="col-text text-center">
						...
						<h4>Whoa there!</h4>
						<p>
							Want to organize your template into a custome folder? Create a folder
							first! Or just save them to “My Templates”
						</p>
					</div>
				)}
			</div>
